...
class StudyGeneric {
    static printArray<T>(params: Array<T>): void {
        console.log(params)
    }
}
...
StudyGeneric.printArray<number>([1, 2, 3])  // nếu để là <number> thì phải trong tham số truyền vào khi gọi hàm thì phải là mảng array
StudyGeneric.printArray<string>(['tuan', 'dep trai']) // tương tự như vậy cũng phải để là string
StudyGeneric.printArray<any>([1, 'tuan', true])
